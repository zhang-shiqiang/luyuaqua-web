  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="负责人" prop="leaderUserIds">
        <el-select v-model="formData.leaderUserIds" multiple clearable placeholder="请输入负责人">
          <el-option
      ...
      <el-form-item label="班次类型" prop="shiftType">
        <el-select v-model="formData.shiftType" clearable placeholder="请选择班次类型">
          <el-option
            v-for="dict in getIntDictOptions(DICT_TYPE.SYSTEM_SHIFT_TYPE)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
